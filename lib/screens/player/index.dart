...
class AppPlayer extends StatefulWidget {
  ...
  const AppPlayer({Key? key, required this.audio}) : super(key: key);

  @override
  AppPlayerState createState() => AppPlayerState();
}

class AppPlayerState extends State<AppPlayer> with WidgetsBindingObserver {
