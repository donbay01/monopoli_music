  ...
  Widget buildSearchResults() {
    if (searchResults.isEmpty && searchController.text.isNotEmpty) {
      return Padding(
        ...
        child: Text('No results found.',style: mediumText(primaryWhite),),
      );
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          title: Text(artist,style: mediumText(primaryWhite),),
          trailing: Icon(
    ...
    return Wrap(
      ...
      children: selectedArtists
          .map(
            (artist) => Chip(
              label: Text(artist),
              deleteIcon: Icon(Icons.close,color: primaryBlack,),
